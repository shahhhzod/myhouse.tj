...
<!--	Title
	=========================================================-->
<title>Myhouse.tj | Контакты</title>
</head>
<body>
                ...
                <div class="row">
                    <div class="col-lg-4 mb-5 bg-secondary">
                        <div class="contact-info">
                            <h3 class="mb-4 mt-4 text-white">Контакты</h3>
                            ...
                            <ul>
                                ...
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="d-table text-white"><a href="tel:+9929000000000">+992 900-000-0000</a></span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
										...
										<span class="d-table text-white"><a href="mailto:info@myhouse.tj">info@myhouse.tj</a></span>
										</div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-12 col-lg-7">
                        ...
                        <div class="row">
							<div class="col-lg-12">
								<h2 class="text-secondary double-down-line text-center mb-5">Связаться</h2>
								...
								<form class="w-100" action="#" method="post">
									<div class="row">
										<div class="row mb-4">
											...
											<div class="form-group col-lg-6">
												<input type="text"  name="email" class="form-control" placeholder="Адрес электронной почты">
											</div>
											<div class="form-group col-lg-6">
												<input type="text"  name="phone" class="form-control" placeholder="Телефон" maxlength="10">
											</div>
											<div class="form-group col-lg-6">
												<input type="text" name="subject"  class="form-control" placeholder="Предмет">
											</div>
											<div class="col-lg-12">
										...
										<button type="submit" value="send message" name="send" class="btn btn-success w-100 rounded">Отправить сообщение</button>
									</div>
								</form>
							</div>
						</div>
