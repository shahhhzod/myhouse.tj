    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>СВОЙСТВА ФИЛЬТРА</b></h2>
                    </div><!-- FOR MORE PROJECTS visit: codeastro.com -->
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                <li class="breadcrumb-item text-white"><a href="#">Главная</a></li>
                                <li class="breadcrumb-item active">СВОЙСТВА ФИЛЬТРА</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
					...
					<div class="col-lg-8">
						...
						<!-- FOR MORE PROJECTS visit: codeastro.com -->
                            ...
                            <?php 		
									...
									echo "<h1 class='mb-5'><center>Недвижимость недоступна                                    </center></h1>";
								}
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar-widget">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4">Калькулятор рассрочки</h4>
						<form class="d-inline-block w-100" action="calc.php" method="post">
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="amount" placeholder="Цена недвижимости">
                            </div>
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="month" placeholder="Продолжительность Год">
                            </div>
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="interest" placeholder="Процентная ставка">
                            </div>
                            <button type="submit" value="submit" name="calc" class="btn btn-success w-100 rounded mt-4">Рассчитать взнос</button>
                        </form>
                        </div>
                        
                        <div class="sidebar-widget mt-5">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">Недавно добавленное </h4>
